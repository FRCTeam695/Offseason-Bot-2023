...
public class MoveOutCommunityRed {

    public static Trajectory getTrajectory() {
        double endPoint = Units.inchesToMeters(160);

        TrajectoryConfig trajectoryConfig1 = new TrajectoryConfig(
                Constants.SummerSwerve.MAX_SPEED_METERS_PER_SECONDS * 0.3,
        ...
        Trajectory trajectory1 = TrajectoryGenerator.generateTrajectory(
                ...
                new Pose2d(endPoint, Units.inchesToMeters(0), new Rotation2d(0)),
                trajectoryConfig1);
